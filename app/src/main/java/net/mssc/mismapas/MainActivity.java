...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void peticionRutas() {
        ...
        String URL_PETICION = "https://maps.googleapis.com/maps/api/directions/json?origin=Toronto&destination=Montreal&key=AIzaSyBHtYD_i3eqYqdCroUTQDwzb5FtqD323oc";
